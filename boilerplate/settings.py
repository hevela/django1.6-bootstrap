...
SECRET_KEY = 't^+ua5js-#2gn48vb%8+z$x!)bvq$5y4+dlweb!-w2ee#1htwm'
...
#---------IMPORTANT-----------#
#Change the name for your project, also change the name of the main app
...
INSTITUTION = "Instituto Milenio"

DOMAIN = "institutomilenio.mx"